module github.com/maxnilz/grpc-istio-demo
...
require (
	...
	github.com/grpc-ecosystem/go-grpc-middleware v0.0.0-20180323085839-aed189ae50cf // indirect
	...
	istio.io/pkg v0.0.0-20190603185215-940899ee7e72 // indirect
	k8s.io/api v0.0.0-20190222213804-5cb15d344471 // indirect
	k8s.io/apiextensions-apiserver v0.0.0-20190221221350-bfb440be4b87 // indirect
